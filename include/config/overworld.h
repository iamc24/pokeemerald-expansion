...
#define OW_FLAG_NO_TRAINER_SEE      FLAG_TRAINERS_REQUIRE_TALK  // If this flag is set, trainers will not battle the player unless they're talked to.
...
#define OW_FLAG_POKE_RIDER          FLAG_ALWAYS_FLY  // If this flag is set, the player will be able to use fly from the Pokenav Region Map and the Town Map key item by pressing 'R' on a city/location they are able to fly to.
